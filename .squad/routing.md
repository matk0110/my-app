...
|-----------|----------|----------|
| Architecture & design | Keaton | System design, component boundaries, data flow decisions |
| React components & UI | Fenster | Gantt chart, Dashboard, DetailPanel, new views, styling |
| Syncfusion Gantt config | Fenster | Chart columns, task fields, timeline settings, editing |
| Dataverse & Power Apps | McManus | Services, models, data fetching, power.config.json |
| Data models & schemas | McManus | Entity relationships, field mappings, generated code |
...
| `squad:keaton` | Architecture, review, scope decisions | Keaton |
| `squad:fenster` | React UI, Gantt chart, Dashboard, components | Fenster |
| `squad:mcmanus` | Dataverse services, Power Apps SDK, data layer | McManus |
| `squad:hockney` | Tests, QA, edge cases, quality gates | Hockney |
